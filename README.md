...
2. GitHub'da boş repo oluşturun
3. Proje kökünde:

```powershell
git init
git add .
git commit -m "feat: WPF kütüphane otomasyonu ve GitHub şablonları"
git branch -M main
git remote add origin https://github.com/KULLANICI_ADINIZ/Ayberk-Kutuphane-Otomasyonu.git
git push -u origin main
```

`KULLANICI_ADINIZ` ve repo adını kendi bilgilerinizle değiştirin.
...
[MIT](LICENSE) — Copyright (c) 2026 Ayberk
